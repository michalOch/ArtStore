...
namespace ArtStore.Migrations
{
    ...
    [Migration("20211212082345_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtStore.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2021, 12, 12, 8, 23, 44, 725, DateTimeKind.Utc).AddTicks(7241),
                            OrderNumber = "12345"
                        });
                });
            ...
            modelBuilder.Entity("ArtStore.Data.Entities.StoreUser", b =>
                {
            ...
            modelBuilder.Entity("ArtStore.Data.Entities.Order", b =>
                {
                    b.HasOne("ArtStore.Data.Entities.StoreUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ArtStore.Data.Entities.StoreUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
